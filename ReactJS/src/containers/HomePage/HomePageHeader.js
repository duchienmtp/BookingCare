            ...
            <div className="center-content">
              <div className="child-content">
                <div>
                  ...
                  <span className="subs-title d-block">
              ...
              <div className="child-content">
                <div>
                  <b>
                    <FormattedMessage id="homeHeader.healthCheckupPackage" />
                  </b>
                  <span className="subs-title d-block">
                    <FormattedMessage id="homeHeader.generalHealthCheckup" />
                  </span>
                </div>
              </div>
            </div>
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(HomePageHeader)
);
